        ...
        <div className="relative space-y-4 pt-2">
          {filteredLogs.map((log) => (
            <div key={log._id} className="relative group">
              ...
              {/* Log Entry Card */}
              <div className="rounded-xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-3 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.04)] hover:shadow-md hover:border-slate-200/80 dark:hover:border-slate-750 transition-all duration-300">
                ...
                <Separator className="my-2 bg-slate-100/80 dark:bg-slate-800" />

                <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[11px] text-slate-500 dark:text-slate-400">
                  <div className="flex items-center gap-1.5">
                    <div className="flex h-4 w-4 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-[8px] font-bold text-slate-600 dark:text-slate-300 shrink-0">
                      {getInitials(log.changedBy.name)}
                    </div>
                    <span className="font-semibold text-slate-700 dark:text-slate-300">{log.changedBy.name}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-[9px] uppercase font-extrabold tracking-wider px-1 py-0.5 rounded bg-slate-50 dark:bg-slate-800 text-slate-400 shrink-0">
                      Timestamp
                    </span>
