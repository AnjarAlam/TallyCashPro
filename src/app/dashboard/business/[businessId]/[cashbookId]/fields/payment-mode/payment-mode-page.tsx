...
import { CopyPaymentModeDialog } from "@/components/dashboard/paymentmode/copy-payment-mode-dialog";
    ...
    <div className="space-y-6">
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <PaymentModeSheet businessId={businessId} cashbookId={cashbookId} />
        </div>
      </div>

      {cashbookId && (
        <CopyPaymentModeDialog
          open={showCopyDialog}
      ...
      {/* Payment Modes List */}
      <PaymentModeList businessId={businessId} cashbookId={cashbookId} statusFilter={statusFilter} />
    </div>
  );
}
